...
{
    /// <inheritdoc />
    public partial class SeedRegionsAndDifficultiesTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("03dc5bb5-9ceb-4212-951c-71568f6f90d4"), "Easy" },
                    { new Guid("a751eb5c-3e6b-4a97-9523-819aadf38115"), "Hard" },
                    { new Guid("b130561e-0da7-433b-bea6-2d1bc735b970"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("03dc5bb5-9ceb-4212-951c-71568f6f90d4"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a751eb5c-3e6b-4a97-9523-819aadf38115"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("b130561e-0da7-433b-bea6-2d1bc735b970"));
